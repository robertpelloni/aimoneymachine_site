...
luxury_css = r"""/* ULTRA-SPECIFIC OVERRIDES */
...
body {
    ...
    background-image: linear-gradient(180deg, #060608 0%, #0B0D11 40%, #0E1117 100%) !important;
}
h1, h2, h3, h4, h5, h6 {
...
h2 { font-size: 2.2em !important; border-bottom: 2px solid rgba(212,175,55,0.3) !important; padding-bottom: 0.5em !important; }
...
.wp-block-post:hover {
    ...
    box-shadow: 0 20px 60px rgba(212,175,55,0.18) !important;
}
...
content += "\n\n// AI Money Machine - Ultra-Specific Luxury Override\n"
...
print("Ultra-specific luxury override applied")
