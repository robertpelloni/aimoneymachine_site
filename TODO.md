...
- [x] **Real Social Posting** (v1.0.0-alpha.81) — Replaced stubs in `hustle/social/post.go` with real Twitter/LinkedIn API calls.
...
## ✅ Completed
- [x] **Real Social Posting** (v1.0.0-alpha.81)
